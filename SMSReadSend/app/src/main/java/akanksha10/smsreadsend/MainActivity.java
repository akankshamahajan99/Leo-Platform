package akanksha10.smsreadsend;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String signature = "hwdhjb^8764#gyfEhgh::";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setting list view for smsMessages
        ...
        btnSendSMS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String msg = signature + etMessage.getText().toString();
    ...
    //A method for updating sms list
